...
<body>
<form action="board-update-result.jsp" name="board">
	...
	%>	
				...
				<div>내용 : <textarea cols="50" rows="10" name="contents"><%= rs.getString("contents") %></textarea></div>
				<button type="submit" onclick="fnUpdate()">저장</button>
	<%			
			} else {
