	...
	<div class="wrap">
		...
		<form action="join-insert.jsp" name="user">
			...
			<div class="info">
				...
				<div>
					<label class="title">이름</label> <input type="text" name="name">
				</div>
				<br>
				<div>
					<label class="title">아이디</label> <input type="text" name="id"
						id="userId" maxlength="12">
					<button type="button" onclick="fn_idCheck()">중복체크</button>
					<br>
				</div>
				<br>
				<div>
					<label class="title">비밀번호</label> <input type="password" name="pwd"
						maxlength="20">
				</div>
				<br>
				<div>
					<label class="title">전자우편</label> <input type="text"
						id="email_in01" name="email1" value=""> @ <input
						type="text" id="email_in02" name="email2" readonly="readonly"
						value=""> <select id="selectEmail"
						onchange="fn_selectemail(this);">
				...
				<br>
				<div>
					<label class="title">휴대전화</label> <select id="tel2_1" name="phone1">
					...
					</select> - <input type="text" name="phone2" id="tel2_2" maxlength="4">
					- <input type="text" name="phone3" id="tel2_3" maxlength="4">
				</div>
				<br>
				<div>
					<label class="title">성별</label> <label class="gender">남<input
						type="radio" name="gender" value="M"></label>
					<label class="gender">여<input type="radio" name="gender"
						value="F"></lable>
				</div>
				<br>
...
<script>
	...
	function fn_idCheck() {
		...
		window.open("idCheck.jsp?userId=" + encodedUserId, "idCheck");
	}
